...
@section('title', 'Tambah Dosen Page')
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Tambah Dosen Page</h3>
                    <p class="text-subtitle text-muted">Halaman untuk menambah data dosen</p>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Form Tambah Data Dosen</h4>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form" action="{{ route('dosen.store') }}" method="POST"
