                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Riwayat Input Skripsi</h4>
                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="judul1"
                                                    ...
                                                    placeholder="Input planning judul TA..." name="judul_1"
                                                    value="{{ old('judul_1') }}" />
                                                @error('judul_1')
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="deskripsi1"
                                                    ...
                                                    placeholder="Input deskripsi TA..." name="deskripsi_1"
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="output1"
                                                    ...
                                                    placeholder="Input output TA..." name="output_1"
                                                    value="{{ old('output_1') }}" />
                                                @error('output_1')
                                                    <div class="invalid-feedback">
                                                        <i class="bx bx-radio-circle"></i>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="judul2"
                                                    ...
                                                    placeholder="Input planning judul TA..." name="judul_2"
                                                    value="{{ old('judul_2') }}" />
                                                @error('judul_2')
                                                    <div class="invalid-feedback">
                                                        <i class="bx bx-radio-circle"></i>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="deskripsi2"
                                                    ...
                                                    placeholder="Input deskripsi TA..." name="deskripsi_2"
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="output2"
                                                    ...
                                                    placeholder="Input output TA..." name="output_2"
                                                    value="{{ old('output_2') }}" />
                                                @error('output_2')
                                                    <div class="invalid-feedback">
                                                        <i class="bx bx-radio-circle"></i>
